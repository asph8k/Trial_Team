        ...
        <div class="table-box col-lg second-section" >
            ...
            <div>
                ...
                <div class="notice-regi-btn">
                    ...
                    <button class="btn btn-outline-secondary" type="button" id="inputGroupFileAddon04" onclick="location.href='<c:url value="/app/appDetailInsRecom/${AppRcUpdt.anmNoSeq}?page=${param.page}"/>'">취소</button>
