    ...
    <section class = "py-3 total-sec">
        ...
        <div class="table-box col-lg second-section" >
            ...
            <div>
                <div>
                    <div>
                    <form name="delInsReForm" action="<c:url value='/app/appInsttUnq'/>" method="post">
                        ...
                        <textarea style="width: 100%; resize: none; border-radius: 5px; border:1px solid #d6d6d6; height:200px;" readonly>${AppRecomDet.insttMemo}</textarea>
					</form>
                    </div>
                ...
                <div class="notice-regi-btn">
                    ...
                    <button class="btn btn-outline-secondary" type="button" id="inputGroupFileAddon04" onclick="location.href='<c:url value="/app/appUpdateInsRecom/${AppRecomDet.anmNoSeq}?page=${param.page}&cpp=10"/>'">수정</button>
                </div>
